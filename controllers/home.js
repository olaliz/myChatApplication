...
module.exports = function(async, Lifestyle, _, Users, Message, FriendResult){
     return{
        SetRouting: function(router){
         ...
         homePage: function(req, res){
              async.parallel([
                  ...
                  res.render('home', {title: 'lizochat - Home', user: req.user, chunks: dataChunk, 
