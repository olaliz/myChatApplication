        ...
        getchatPage: function(req, res){  
            async.parallel([
                ...
                const nameParams = params[0];
                      ...
                      res.render('private/privatechat', {title: 'Chatting - Private Chat', user: req.user, data: result1, chat: result2, chats: result3, name: nameParams});
               });       
            },
            ...
            chatPostPage: function(req, res, next){
                    const params = req.params.name.split('.');
                    const nameParams = params[0];
                    const nameRegex = new RegExp("^"+nameParams.toLowerCase(), "i");  //search for the user in database and ignore any case and return value that matches
