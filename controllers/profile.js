    ...
    return {
            ...
            async.parallel([
                   function(callback){
                    ...
                    function(callback){
                     ...
                     res.render('user/profile', {title: 'lizochat - Profile', user:req.user, data: result1, chat: result2});  
               });
         },
              ...
              async.waterfall([
                ...
                function(result, callback){
                    if(req.body.upload === null || req.body.upload === '') {
                        ...
                        {
                            upsert: true     //check any fiels that is not already in the document and add
                        }, (err, result) => {
                        ...
                        {
                            upsert: true     //check any fields that is not already in the document and add
                        }, (err, result) => {
                            res.redirect('/settings/profile');
                        })
                    }
        ...
        overviewPage: function(req, res){
            async.parallel([
                ...
                res.render('user/overview', {title: 'lizochat - Overview', user:req.user, data: result1, chat:result2});
            });
        },
